...
# Re-using the train_epoch and evaluate functions from our previous main.py
...
def main():
    ...
    # --- MODEL LOADING FOR CUSTOM ARCHITECTURE ---
    ...
    # Load your custom pretrained weights into the encoder part of the model
    # strict=False is important because the checkpoint doesn't contain the biaffine parser head weights
