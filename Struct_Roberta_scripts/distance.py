...
from models_rs import StructBiaffineParser
...
def main():
    parser = argparse.ArgumentParser(description="StructRoberta Distance/Direction Analysis")
    parser.add_argument('--model_dir', default='src/fintunedmodels/struct_roberta_hi')
    parser.add_argument('--test_data', required=True, help="Path to the test .conllu file")
    parser.add_argument('--pretrained_model', default='src/models/Roberta_hi')
    parser.add_argument('--tokenizer_path', default='src/hindi_RobertaTok')
    parser.add_argument('--batch_size', type=int, default=16)
    parser.add_argument('--output_dir', default='src/struct_roberta_hi_scripts/distance_error_analysis_STRUCT_ROBERTAHI')
