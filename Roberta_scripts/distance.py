...
def main():
    parser = argparse.ArgumentParser(description="Roberta_Hi Distance/Direction Analysis")
    parser.add_argument('--model_dir', default='src/fintunedmodels/roberta_hi_finetuned')
    ...
    parser.add_argument('--output_dir', default='src/roberta_hi_scripts/distance_error_analysis_Roberta_hi')
